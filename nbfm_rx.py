...
class nbfm_rx(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "nbfm_rx")
        ...
        self._freq_range = qtgui.Range(446e6, 447e6, 1000, 446e6, 200)
        self._freq_win = qtgui.RangeWidget(self._freq_range, self.set_freq, "'freq'", "counter_slider", float, QtCore.Qt.Horizontal)
        self.top_layout.addWidget(self._freq_win)
        self._Gain_rf_range = qtgui.Range(0, 48, 1, 30, 200)
        self._Gain_rf_win = qtgui.RangeWidget(self._Gain_rf_range, self.set_Gain_rf, "'Gain_rf'", "counter_slider", float, QtCore.Qt.Horizontal)
        ...
        self.rational_resampler_xxx_0 = filter.rational_resampler_ccc(
                ...
                taps=[],
                fractional_bw=0)
        self.freq_xlating_fir_filter_xxx_0 = filter.freq_xlating_fir_filter_ccc(20, firdes.low_pass(1.0,2e6,5e3,2e3), 0, samp_rate)
        ...
        self._bandwidth_range = qtgui.Range(3e3, 250e3, 10e3, 3e3, 200)
        ...
        self.connect((self.rtlsdr_source_0, 0), (self.fosphor_qt_sink_c_0, 0))
